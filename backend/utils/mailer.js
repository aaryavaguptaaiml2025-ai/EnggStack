...
async function sendOTPEmail(toEmail, otp, name) {
  ...
  await transporter.sendMail({
    from: `"EnggStack" <${from}>`,
    to: toEmail,
    subject: `${otp} — Your EnggStack verification code`,
    html: `
      <div style="font-family:Inter,system-ui,sans-serif;max-width:480px;margin:0 auto;background:#0d0d0d;border-radius:16px;overflow:hidden">
        <div style="background:#0f172a;padding:28px 32px;text-align:center">
          <div style="width:52px;height:52px;background:#4ade80;border-radius:14px;display:inline-flex;align-items:center;justify-content:center;font-size:24px;font-weight:900;color:#000;margin-bottom:12px">E</div>
          <div style="font-size:20px;font-weight:800;color:#f0f0f0">EnggStack</div>
        ...
        <div style="padding:32px">
          ...
          <p style="font-size:13px;color:#888;margin:0 0 24px">Here's your verification code to complete registration:</p>
          <div style="background:#161616;border:1px solid #2a2a2a;border-radius:12px;padding:24px;text-align:center;margin-bottom:24px">
            <div style="font-size:42px;font-weight:800;letter-spacing:12px;color:#4ade80;font-family:monospace">${otp}</div>
