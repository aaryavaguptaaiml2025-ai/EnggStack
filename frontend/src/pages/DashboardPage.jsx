...
const QUICK_ACTIONS = [
  ...
  { icon:"forum",          label:"Ask AI",    to:"/ai",           c:"#ec4899" },
];
...
function buildSuggestions(subjects, deadlines, stats) {
  ...
  if ((stats.minsToday || 0) === 0)
    out.push({ icon: "play_circle", text: "You haven't studied yet today", color: "#60a5fa" });
  else if ((stats.minsToday || 0) < 30)
    out.push({ icon: "target", text: "Keep going — you're just getting started", color: "#60a5fa" });

  if ((stats.streak || 0) >= 3)
    out.push({ icon: "local_fire_department", text: `${stats.streak}-day streak — don't break it!`, color: "#f97316" });

  if (!out.length)
    out.push({ icon: "check_circle", text: "Great job! Keep the momentum going.", color: "#00FFB2" });
  ...
  return (
    <div className="page-container">
      ...
      <div className="glass-card p-5 mb-6 flex items-center gap-4">
        ...
        {goalPct >= 100 && (
          <span className="material-symbols-outlined text-[#00FFB2] text-2xl filled">
            check_circle
          </span>
        )}
      </div>
      ...
      <div className="grid-3 grid grid-cols-3 gap-5 mb-5">
        ...
        <Card accent="#60a5fa">
          <div className="flex justify-between items-center mb-4">
            ...
            <button
              ...
              className="text-[11px] text-[#00FFB2] hover:underline font-semibold"
            >
              Manage
            </button>
          </div>
                ...
                >
                  <div className="flex justify-between mb-1.5 items-center">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        onClick={() => navigate("/subjects")}
                        className="text-[9px] text-muted hover:text-[#00FFB2] transition-colors
        ...
        <Card accent="#00FFB2">
          <div className="flex items-center justify-between mb-4">
            ...
            {weekTotal > 0 && (
              <span className="text-[10px] text-[#00FFB2] font-bold">
          ...
          <div className="flex items-end gap-1 h-20 mb-2">
            {wMins.map((m, i) => (
              <div key={i} className="flex-1 flex flex-col items-center gap-1 h-full">
                ...
                <span
                  className={`text-[8px] ${
                    i === todayIdx ? "text-[#00FFB2] font-bold" : "text-dim"
                  }`}
                >
                  {DAYS[i]}
                </span>
          ...
          <div className="border-t border-white/5 pt-2 flex justify-between">
            ...
            <span className="text-[11px] text-[#00FFB2] font-bold">{weekTotal} mins</span>
          </div>
        </Card>
      </div>
      ...
      <div className="grid-3 grid grid-cols-[1.3fr_1fr_1fr] gap-5 mb-5">
        ...
        <Card>
          <div className="flex justify-between items-center mb-4">
            <div className="flex items-center gap-2">
              <span className="material-symbols-outlined text-purple text-lg filled">
                workspace_premium
              </span>
